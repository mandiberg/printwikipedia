...
/**
   * Encode the <i>wiki links title</i> into a URL for HTML hyperlinks (i.e.
	 ...
	 * To get the behavior of the MediaWiki software, which is
	 * configured to convert the first letter to upper case, the
	 * <code>firstCharacterAsUpperCase</code> parameters must be set to <code>true</code>.
	 * 
	 * @param wikiTitle the raw wiki title
