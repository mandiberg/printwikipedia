...
def luluCruise(inputFile,volumeNum,title):
	...
	print "options"
	pgCount = browser.find_element_by_xpath("//*[@id='inputPageCount']")
	binding = browser.find_element_by_xpath("//*[@id='bindingTypeOption_casewrap-hardcover']")
	...
	# uploadError = browser.find_element_by_xpath("/html/body/div/div[3]/div[2]/div/span").text
