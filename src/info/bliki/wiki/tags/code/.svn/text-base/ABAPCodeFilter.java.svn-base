...
public class ABAPCodeFilter implements SourceCodeFormatter {
  ...
  public static void createHashMap(HashMap<String, String> map, String str) {
    map.put(str, "<b>" + AbstractCPPBasedCodeFilter.FONT_KEYWORD + str + AbstractCPPBasedCodeFilter.FONT_END + "</b>");
  }

  private int appendIdentifier(String input, int identStart, int currentPosition, HashMap<String, String> keywords, HashSet<String> objectWords,
